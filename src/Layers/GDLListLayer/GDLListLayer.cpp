...
"The <cr>official</c> ranking for the <cb>Gild56</c> List";
...
bool GDLListLayer::init() {
	...
	auto gdlBG = CCSprite::create("background.png"_spr);
	...
	m_infoBtn = InfoAlertButton::create("Gild56 List", GLOBAL_LIST_INFO, 1.0f);
	...
	m_randomBtn = CCMenuItemExt::createSpriteExtraWithFilename("random_button.png"_spr, 0.9f, [this](auto) {
